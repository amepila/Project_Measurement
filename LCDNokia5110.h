...
/*It writes a byte in the LCD memory. 
 * The place of writting is the last place that was indicated
 * by LCDNokia_gotoXY. In the reset state
...
/*It is used to indicate the place for writing a new character 
 * in the LCD. The values that x can take are 0 to 84 and y can
...
void LCDNokia_sendString(const uint8_t*);
